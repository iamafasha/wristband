            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="">
                    <div class="md:flex justify-between">
                            ...
                            <div class="p-6 w-full shadow-sm sm:rounded-lg bg-white border-b border-gray-200 mt-5">
                                ...
                                <div class="pt-5">
                                    <ul class="devices border-spacing-2 table w-full">
                                        <li v-for="device in props.patient.devices" :key="device.id" class="device md:table-row ">
                        ...
                        <div class="md:w-8/12 mt-2  md:mt-0 md:pl-4">
                            ...
                            <div class="p-6 w-full shadow-sm sm:rounded-lg bg-white border-b border-gray-200 mt-5">
                                ...
                                <div class="">
                                    <ul class="devices border-spacing-2 table w-full ">
                                        <li v-for="contact_person in props.patient.contact_persons" :key="contact_person.id" class="device md:table-row ">
                                                <div class="name md:table-cell">
                                                    <h3>{{ contact_person.name }}</h3>
                                                </div>

                                                <div class="email md:table-cell">
                                                    <h3>{{ contact_person.email }}</h3>
                                                </div>

                                                <div class="phone md:table-cell">
